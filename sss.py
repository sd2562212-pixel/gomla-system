...
st.set_page_config(page_title="سيستم محل الجملة - النسخة الأولى", layout="centered")
...
conn = sqlite3.connect('gomla_shop_v1_system.db', check_same_thread=False)
cursor = conn.cursor()
...
# إضافة بضاعة تجريبية للمخزن لتشغيل السيستم فوراً إذا كان فارغاً
...
tab1, tab2, tab3 = st.tabs(["📊 أسعار اليوم", "👥 الديون والحسابات", "📦 الفواتير والمخزن"])
